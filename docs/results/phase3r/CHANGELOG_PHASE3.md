# Experiment 01 Phase III-R — changelog

- Recorded Phase-III v1 termination status `terminated_pre_test_compute_infeasible` before selection freeze and before test access.
- Froze a compute-feasible 1296-model amendment before test access.
- Retained 2 adjacent primary low budgets, full-budget ceilings, 2 branches, 3 encoder seeds, 3 paired subset seeds and 3 reader seeds.
