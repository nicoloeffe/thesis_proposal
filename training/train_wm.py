...
class WMDataset(Dataset):
    ...
    Ogni campione è:
      ...
      regime      : scalar           — regime della sequenza (0/1/2)
...
def train(args: argparse.Namespace) -> None:
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        for z_seq, a_seq, rewards, regimes in train_loader:
            ...
            z_next = z_seq[:, 1:, :]   # targets: z_1..z_N
        ...
        with torch.no_grad():
            for z_seq, a_seq, rewards, regimes in val_loader:
                ...
                # Entropy of π (mode collapse check)
        ...
        print(
            ...
            f"train_nll={tr_nll:.4f}  val_nll={val_nll:.4f}  "
            f"ent_π={val_ent:.3f}  "
