...
def main() -> None:
    ...
    # train/val split, and is held FIXED across seeds and across arms so that
    # multi-seed error bars measure optimization variance (init + minibatch
    # ordering), NOT split variance. --seed varies; --split_seed does not.
