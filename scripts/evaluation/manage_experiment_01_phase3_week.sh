...
SESSION_NAME="experiment01-phase3"
LAUNCHER="${PROJECT_ROOT}/scripts/evaluation/launch_experiment_01_phase3_week.sh"
RUNNER_DIR="${PROJECT_ROOT}/validation/experiment01/execution_20260730/phase3_runner"
